...
module RFLU_ModLibVTKIO
!-----------------------------------------------------------------------------------------------------------------------------------
USE RFLU_ModIRPrecision                                                         ! Integers and reals precision definition.
USE RFLU_ModLibBase64                                                           ! Base64 encoding/decoding procedures.
...
contains
  ...
  character(len=100):: Upper_Case
  integer::                      n1         !< Characters counter.
  !---------------------------------------------------------------------------------------------------------------------------------

  !---------------------------------------------------------------------------------------------------------------------------------
  !Upper_Case = string
  Upper_Case = trim(string)
  do n1=1,len(string)
